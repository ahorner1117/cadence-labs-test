...
let optionButtons = document.querySelectorAll(".variant-selector-button");
optionButtons.forEach((btn) => {
  btn.onclick = function(){
   let concernedOption = btn.closest('.selector-wrapper').querySelector('select.single-option-selector');
   concernedOption.selectedIndex = btn.dataset.index;
   concernedOption.dispatchEvent(new Event('change'));

   // active styling for the button
   btn.closest('.selector-wrapper').querySelector('.variant-selector-button.selected').classList.remove('selected');
